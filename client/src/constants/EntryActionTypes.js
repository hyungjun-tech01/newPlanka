...
export default {
  ...
  /* status hjkim add  */
  STATUS_TO_FILTER_IN_CURRENT_BOARD_ADD: `${PREFIX}/STATUS_TO_FILTER_IN_CURRENT_BOARD_ADD`,
  STATUS_FROM_FILTER_IN_CURRENT_BOARD_REMOVE: `${PREFIX}/STATUS_FROM_FILTER_IN_CURRENT_BOARD_REMOVE`,
